...
EXPECTED_FILES = (
    ...
    "output/table_nonoverlap_permutation.csv",
    ...
    "data/crisis_2008_pi.csv",
    "data/control_2004_2006_pi.csv",
    "data/crisis_terra_luna_pi.csv",
    "data/control_terra_luna_pi.csv",
    "data/crisis_fukushima_pi.csv",
    "data/control_fukushima_pi.csv",
    "data/crisis_covid_pi.csv",
    "data/control_covid_pi.csv",
    "data/crisis_supply_chain_pi.csv",
    "data/control_supply_chain_pi.csv",
